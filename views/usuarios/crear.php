    ...
    <div class="dashboard-container">
        ...
        <main class="content d-flex flex-column">
            <header class="toolbar bg-white p-3 d-flex justify-content-between align-items-center mb-4">
                <h1 class="m-0 fs-3 fw-bold">Crear usuario</h1>
                <a href="../../backend/logout.php" class="btn btn-primary rounded-3 px-3 py-1">Salir</a>
            </header>

            <div class="px-4 pb-5">
                <div class="card-custom p-4 mx-auto form-card">
                    <p class="text-muted">Complete los datos del nuevo usuario. Esta vista todavía no guarda información.</p>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" placeholder="8888-8888">
                        </div>
