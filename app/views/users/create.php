...
<!-- Para ver la pagina ya que no hay nada que pueda acceder esto seria " http://localhost/ProyectoAmbienteWeb/public/user/create" -->
...
<body class="usuarios-body">
    ...
    <header class="usuarios-topbar">
        <a href="/ProyectoAmbienteWeb/dashboard.php" class="usuarios-brand">
            <img src="/ProyectoAmbienteWeb/Public/img/logo.jpg" alt="Logo"class="usuarios-logo">
