...
<div class="modal fade" id="modalPagar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="finalizarPago">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="numeroTarjeta" maxlength="16" minlength="16" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Fecha de Vencimiento</label>
                        <div class="mb-3" id="fechaVencimiento">
                            <input type="text" class="form-control" id="fechaTarjeta" maxlength="2" placeholder="MM"required>
                            <span>/</span>
                            <input type="text" class="form-control" id="anioTarjeta" maxlength="2" placeholder="YY" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">CVV</label>
                        <input type="text" class="form-control" id="cvvTarjeta" maxlength="3" minlength="3" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn-total">Finalizar Pago</button>
                </div>
            </form>
        </div>
    </div>
